...
export const TopRatedIndiaComponent = ({movies , AddToFavourite , favouriteChecker , removeFromFavourite}:Props) => {
    ...
    <>
      {
        movies.map((movies , index)=>(
          ...
          <Link to={`/top-rated-india/${movies.id}`} style={{textDecoration:"none", color:"white"}}><Card.Img variant="top" src={movies.posterurl?movies.posterurl:imgalt} alt={movies.title} className="CoverImage"/>
          </Link>  
