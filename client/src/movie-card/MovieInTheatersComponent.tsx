...
export const MovieInTheatersComponent = ({movies , AddToFavourite , favouriteChecker , removeFromFavourite}:Props) => {
    ...
    <>
      {
        movies.map((movies , index)=>(
          ...
          <Link to={`/movies-in-theaters/${movies.id}`} style={{textDecoration:"none", color:"white"}}><Card.Img variant="top" src={movies.posterurl?movies.posterurl:imgalt} alt={movies.title} className="CoverImage"/>
          </Link>  
