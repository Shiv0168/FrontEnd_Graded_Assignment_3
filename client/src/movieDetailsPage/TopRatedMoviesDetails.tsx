...
import { MovieComingDetailsFetch, TopRatedMoviesDetailsFetch } from "../service/MoviesDetailsApiFetch";

export const TopRatedMoviesDetails = () => {
...
const getData = () => {
  ...
  const response = await TopRatedMoviesDetailsFetch(+(id?id:"370"))
