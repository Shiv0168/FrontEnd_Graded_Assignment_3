...
import { FavouriteMoviesDetailsFetch, MovieComingDetailsFetch, TopRatedMoviesDetailsFetch } from "../service/MoviesDetailsApiFetch";
...
const getData = () => {
  ...
  const response = await FavouriteMoviesDetailsFetch(+(id?id:"2"))
