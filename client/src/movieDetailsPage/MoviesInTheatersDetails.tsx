...
import { MovieComingDetailsFetch, MoviesInTheatersDetailsFetch, TopRatedMoviesDetailsFetch } from "../service/MoviesDetailsApiFetch";

export const MoviesInTheatersDetails = () => {
...
const getData = () => {
  ...
  const response = await MoviesInTheatersDetailsFetch(+(id?id:"96"))
